...
{
    public class LogradouroRepository : BaseRepository<Endereco>, ILogradouroRepository
    {
        public LogradouroRepository(string connectionString, DatabaseType databaseType) : base(connectionString, databaseType) { }
        public override async Task<Endereco> Adicionar(Endereco entity)
        {
            try
            {
        ...
        public async Task<Endereco?> ObterPorCep(string cep)
        {
        ...
        public override async Task<Endereco> Atualizar(Endereco entity)
        {
            try
            {
                await using var connection = await GetOpenConnectionAsync();
        ...
        public async Task<IEnumerable<Endereco>> ObterPorCidade(string cidade)
        {
            try
            {
                await using var connection = await GetOpenConnectionAsync();
                ...
                using var reader = await command.ExecuteReaderAsync();
                var logradouros = new List<Endereco>();
        ...
        protected override async Task<Endereco> MapAsync(DbDataReader reader)
        {
            try
            {
                var logradouro = Endereco.Criar(
