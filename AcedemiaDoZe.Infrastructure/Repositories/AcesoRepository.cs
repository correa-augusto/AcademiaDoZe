        ...
        public async Task<IEnumerable<Aluno>> GetAlunosSemAcessoNosUltimosDias(int dias)
        {
            try
            {
                ...
                while (await reader.ReadAsync())
                {
                    ...
                    var endereco = Endereco.Criar(cep, nome, bairro, cidade, estado, pais);
                    ...
                    var aluno = Aluno.Criar(nome, cpf, dataNascimento, telefone, email, endereco, numero, complemento, senha, objetivo, foto);
            ...
            try
            {
                ...
                else 
                {
                    pessoa = AcademiaDoZe.Domain.Entities.Colaborador.Criar(
                        ...
                        tipo: (PessoaTipo)reader.GetInt32(reader.GetOrdinal("tipo_usuario")),
