    ...
    public class AlunoRepository : BaseRepository<Aluno>, IAlunoRepository
    {
        ...
        public override async Task<Aluno> Adicionar(Aluno entity)
        {
            try
            {
                ...
                ? $"INSERT INTO {TableName} (cpf, telefone, nome, nascimento, email, logradouro_id, numero, complemento, senha, objetivo, foto) "
                + "OUTPUT INSERTED.id_aluno "
                + "VALUES (@Cpf, @Telefone, @Nome, @Nascimento, @Email, @LogradouroId, @Numero, @Complemento, @Senha, @Objetivo @Foto);"
                : $"INSERT INTO {TableName} (cpf, telefone, nome, nascimento, email, logradouro_id, numero, complemento, senha,Objetivo, foto) "
                + "VALUES (@Cpf, @Telefone, @Nome, @Nascimento, @Email, @LogradouroId, @Numero, @Complemento, @Senha, @Objetivo, @Foto); "
