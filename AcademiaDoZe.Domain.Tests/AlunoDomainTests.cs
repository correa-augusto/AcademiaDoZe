...
namespace AcademiaDoZe.Domain.Tests
{
    public class AlunoDomainTests
    {
        ...
        private Endereco GetValidLogradouro() => Endereco.Criar("12345678", "Rua A", "Centro", "Cidade", "SP", "Brasil");
        ...
        public void CriarAluno_ComDadosValidos_DeveCriarObjeto() // Padrão de Nomenclatura: MetodoTestado_Cenario_ResultadoEsperado
        {
            ...
            // Act
            var aluno = Aluno.Criar(nome, cpf, dataNascimento, telefone, email, logradouro, numero, complemento, senha, objetivo, foto);
            // Assert
