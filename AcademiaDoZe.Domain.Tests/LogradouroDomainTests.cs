...
namespace AcademiaDoZe.Domain.Tests
{
    public class LogradouroDomainTests
    {
        ...
        {
            var logradouro = Endereco.Criar("12345670", "Rua A", "Centro", "Cidade", "SP", "Brasil");
        ...
        public void CriarLogradouro_Invalido_DeveLancarExcecao()
        {
            ...
            Assert.Throws<DomainException>(() => Endereco.Criar("123", "Rua A", "Centro", "Cidade", "SP", "Brasil"));
        }
        [Fact]
        public void CriarLogradouro_Valido_VerificarNormalizado()
        {
            var logradouro = Endereco.Criar("12.3456-78 ", " Rua A ", " Centro ", " Cidade ", "S P", "Brasil ");
        ...
        {
            var exception = Assert.Throws<DomainException>(() => Endereco.Criar("12345670", "", "Centro", "Cidade", "SP", "Brasil"));
