    ...
    public class AlunoRepository : BaseRepository<Aluno>, IAlunoRepository
    {
        ...
        public override async Task<Aluno> Adicionar(Aluno entity)
        {
            try
            {
                ...
                command.Parameters.Add(DbProvider.CreateParameter("@Foto",
                 (object)entity.Foto?.Conteudo ?? DBNull.Value, DbType.Binary, _databaseType));
        ...
        public async Task LimparTabela()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new InvalidOperationException("Erro ao limpar a tabela de alunos.", ex);
            }
        }
